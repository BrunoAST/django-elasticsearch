...
from authentication.services.google_auth.google_sdk_login_get_credentials_service import google_sdk_get_login_credentials
...
class GoogleSdkLoginFlowService:
    API_URI = reverse_lazy('api:google-callback')
    ...
    def __init__(self):
        self._credentials = google_sdk_get_login_credentials()
        
    def _get_redirect_uri(self):
        domain = env('DJANGO_BASE_BACKEND_URL', default='')
